...
!! enddo time loop
       ...
       call mpi_reduce(image_ud,image_ud_0,n_count,mpi_real,mpi_sum,0,mpi_comm_world,ierr)
       call mpi_reduce(image_du,image_du_0,n_count,mpi_real,mpi_sum,0,mpi_comm_world,ierr)
       call mpi_reduce(image_uu,image_uu_0,n_count,mpi_real,mpi_sum,0,mpi_comm_world,ierr)
       call mpi_reduce(image_dd,image_dd_0,n_count,mpi_real,mpi_sum,0,mpi_comm_world,ierr)
...
!!     source-normalized cross-correlation 
       ...
       call mpi_reduce(image_ud,image_ud_01,n_count,mpi_real,mpi_sum,0,mpi_comm_world,ierr)
       call mpi_reduce(image_du,image_du_01,n_count,mpi_real,mpi_sum,0,mpi_comm_world,ierr)
       call mpi_reduce(image_uu,image_uu_01,n_count,mpi_real,mpi_sum,0,mpi_comm_world,ierr)
       call mpi_reduce(image_dd,image_dd_01,n_count,mpi_real,mpi_sum,0,mpi_comm_world,ierr)

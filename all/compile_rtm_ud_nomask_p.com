...
$F90 -c imaging_condition_udlr.f90 
$F90 -c imaging_condition_udlr_im.f90
$F90 -c imaging_condition_udlr_eff.f90 
$F90 -c bvr_record_wave_p.f90
$F90 -c bvr_record_wave_vxz.f90
$F90 -c hilbert_seismo.f90
$F90 -c wavefield_decomp.f90
$F90 -c visco_acous_ud_hilbert_nomask.f90 $mp 
$F90 *.o -o rtm_ud_nom_p $mp  -lfftw3f -Wl,-rpath=$LD_RUN_PATH
